...
from PyQt5.QtCore import pyqtProperty, pyqtSignal, QObject, QFileSystemWatcher
...
class MovieInfo(QObject):
    ...
    def __init__(self, filepath=""):
        ...
        self._watcher.fileChanged.connect(lambda path: self.movieSourceChanged.emit(path))
    ...
    def movie_file(self, filepath):
        ...
        self._watcher.addPath(self.filepath)
